    ...
    >
      ...
      >
        ...
        <p className="max-w-xl text-sm text-muted-foreground">
          ...
          multidisciplinary squad that functions as an extension of your own
          tech team.
        </p>
      </motion.div>
      ...
      <div className="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-12 items-center">
        <div className="lg:col-span-5 flex flex-col gap-3.5">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            We integrate directly into your workflows. You get complete
            transparency with direct access to code repositories, Figma project
            files, project taskboards, and messaging channels.
          </p>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {collabTools.map((tool) => {
            ...
            return (
              <Card
                key={tool.name}
                className="border-border/60 bg-muted/20 hover:bg-muted/40 transition-colors duration-300"
              >
